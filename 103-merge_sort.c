...
/**
 * merge_subarr - Sortng a subarray of integers.
...
/**
 * merge_sort_recursive - Implemeningt the merge sort algorithm through recursion.
 * @subarr:subarray of an array of integers to sort.
 * @buff: Buffer to store the sorted result.
 * @front:Front index of the subarray.
 * @back:Bback index of the subarray.
 */
void merge_sort_recursive(int *subarr, int *buff, size_t front, size_t back)
{
	size_t mid;
...
/**
 * merge_sort - Sorting array of integers in ascending
