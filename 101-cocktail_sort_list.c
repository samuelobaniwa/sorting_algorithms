...
/**
 * swap_node_ahead - Swapng node in a listint_t doubly-linked list
 *                   listing the  integers with the node ahead of it.
...
/**
 * swap_node_behind - Swapping  node in a listint_t doubly-linked
...
/**
 * cocktail_sort_list - Soring   listint_t doubly-linked list of integers in
